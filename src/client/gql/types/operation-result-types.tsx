...
export type RemoveMovieMutation = (
  ...
  & { authorized?: Maybe<(
    ...
    & { removeMovie: (
      { __typename?: 'RemovedMovieResponse' }
      & Pick<RemovedMovieResponse, 'id' | 'directorId'>
    ) }
  )> }
);
...
export type FetchDirectorWithIdQueryVariables = Exact<{
  id: Scalars['Int'];
}>;


export type FetchDirectorWithIdQuery = (
  { __typename?: 'Query' }
  & { authorized?: Maybe<(
    { __typename?: 'AuthorizedQuery' }
    & { director: (
      { __typename?: 'Director' }
      & Pick<Director, 'directorId' | 'name' | 'age'>
      & { movies: Array<(
        { __typename?: 'Movie' }
        & Pick<Movie, 'id' | 'title' | 'description' | 'year' | 'directorId' | 'likes'>
      )> }
    ) }
  )> }
);
...
export type LikeSubscription = (
  ...
  & { likeToggled: (
    { __typename?: 'Like' }
    & Pick<Like, 'id' | 'likes' | 'directorId'>
  ) }
);

export type RemovedMovieSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type RemovedMovieSubscription = (
  { __typename?: 'Subscription' }
  & { removedMovie: (
    { __typename?: 'RemovedMovieResponse' }
    & Pick<RemovedMovieResponse, 'id' | 'directorId'>
...
export type RemoveMovieComponentProps = Omit<ApolloReactComponents.MutationComponentOptions<RemoveMovieMutation, RemoveMovieMutationVariables>, 'mutation'>;

    export const RemoveMovieComponent = (props: RemoveMovieComponentProps) => (
      <ApolloReactComponents.Mutation<RemoveMovieMutation, RemoveMovieMutationVariables> mutation={RemoveMovieDocument} {...props} />
    );
...
export const FetchDirectorWithIdDocument = gql`
  ...
  authorized {
    ...
    `;
export type FetchDirectorWithIdComponentProps = Omit<ApolloReactComponents.QueryComponentOptions<FetchDirectorWithIdQuery, FetchDirectorWithIdQueryVariables>, 'query'> & ({ variables: FetchDirectorWithIdQueryVariables; skip?: boolean; } | { skip: boolean; });

    export const FetchDirectorWithIdComponent = (props: FetchDirectorWithIdComponentProps) => (
      <ApolloReactComponents.Query<FetchDirectorWithIdQuery, FetchDirectorWithIdQueryVariables> query={FetchDirectorWithIdDocument} {...props} />
    );
 ...
 * });
 */
export function useFetchDirectorWithIdQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<FetchDirectorWithIdQuery, FetchDirectorWithIdQueryVariables>) {
        return ApolloReactHooks.useQuery<FetchDirectorWithIdQuery, FetchDirectorWithIdQueryVariables>(FetchDirectorWithIdDocument, baseOptions);
      }
export function useFetchDirectorWithIdLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<FetchDirectorWithIdQuery, FetchDirectorWithIdQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<FetchDirectorWithIdQuery, FetchDirectorWithIdQueryVariables>(FetchDirectorWithIdDocument, baseOptions);
        }
export type FetchDirectorWithIdQueryHookResult = ReturnType<typeof useFetchDirectorWithIdQuery>;
export type FetchDirectorWithIdLazyQueryHookResult = ReturnType<typeof useFetchDirectorWithIdLazyQuery>;
export type FetchDirectorWithIdQueryResult = ApolloReactCommon.QueryResult<FetchDirectorWithIdQuery, FetchDirectorWithIdQueryVariables>;
export const LikeDocument = gql`
  ...
  likeToggled {
    ...
    `;
export type LikeComponentProps = Omit<ApolloReactComponents.SubscriptionComponentOptions<LikeSubscription, LikeSubscriptionVariables>, 'subscription'>;

    export const LikeComponent = (props: LikeComponentProps) => (
      <ApolloReactComponents.Subscription<LikeSubscription, LikeSubscriptionVariables> subscription={LikeDocument} {...props} />
    );
...
export function useLikeSubscription(baseOptions?: ApolloReactHooks.SubscriptionHookOptions<LikeSubscription, LikeSubscriptionVariables>) {
        return ApolloReactHooks.useSubscription<LikeSubscription, LikeSubscriptionVariables>(LikeDocument, baseOptions);
      }
export type LikeSubscriptionHookResult = ReturnType<typeof useLikeSubscription>;
export type LikeSubscriptionResult = ApolloReactCommon.SubscriptionResult<LikeSubscription>;
export const RemovedMovieDocument = gql`
  ...
  removedMovie {
    ...
    `;
export type RemovedMovieComponentProps = Omit<ApolloReactComponents.SubscriptionComponentOptions<RemovedMovieSubscription, RemovedMovieSubscriptionVariables>, 'subscription'>;

    export const RemovedMovieComponent = (props: RemovedMovieComponentProps) => (
      <ApolloReactComponents.Subscription<RemovedMovieSubscription, RemovedMovieSubscriptionVariables> subscription={RemovedMovieDocument} {...props} />
    );
 ...
 * });
 */
export function useRemovedMovieSubscription(baseOptions?: ApolloReactHooks.SubscriptionHookOptions<RemovedMovieSubscription, RemovedMovieSubscriptionVariables>) {
        return ApolloReactHooks.useSubscription<RemovedMovieSubscription, RemovedMovieSubscriptionVariables>(RemovedMovieDocument, baseOptions);
      }
export type RemovedMovieSubscriptionHookResult = ReturnType<typeof useRemovedMovieSubscription>;
export type RemovedMovieSubscriptionResult = ApolloReactCommon.SubscriptionResult<RemovedMovieSubscription>;